...
import (
	...
	"github.com/YunFreeTech/webkubectl/gotty/cache/token"
	"github.com/YunFreeTech/webkubectl/gotty/pkg/randomstring"
	"github.com/YunFreeTech/webkubectl/gotty/webtty"
	"github.com/go-redis/redis/v8"
	"github.com/gorilla/websocket"
	"github.com/pkg/errors"

	"github.com/YunFreeTech/webkubectl/gotty/pkg/homedir"
)
...
func New(factory Factory, options *Options, redisOptions *RedisOptions) (*Server, error) {
	...
	if redisOptions.UseRedisTokenCache == "true" {
		...
		cache = token.NewRedisCache(client, "YunFreeTech-webkubectl-")
	} else {
