...
import (
	...
	v1User "github.com/YunFreeTech/kubefree/internal/model/v1/user"
	"github.com/YunFreeTech/kubefree/internal/server"
	"github.com/YunFreeTech/kubefree/internal/service/v1/cluster"
	"github.com/YunFreeTech/kubefree/internal/service/v1/common"
	"github.com/YunFreeTech/kubefree/internal/service/v1/ldap"
	"github.com/YunFreeTech/kubefree/internal/service/v1/role"
	"github.com/YunFreeTech/kubefree/internal/service/v1/rolebinding"
	v1SystemService "github.com/YunFreeTech/kubefree/internal/service/v1/system"
	"github.com/YunFreeTech/kubefree/internal/service/v1/user"
	"github.com/YunFreeTech/kubefree/pkg/collectons"
	"github.com/YunFreeTech/kubefree/pkg/kubernetes"
...
func (h *Handler) GetClusterProfile() iris.Handler {
	return func(ctx *context.Context) {
		...
		labels := []string{
			fmt.Sprintf("%s=%s", kubernetes.LabelManageKey, "kubefree"),
