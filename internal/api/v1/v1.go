...
import (
	...
	"github.com/YunFreeTech/kubefree/internal/api/v1/chart"
	"github.com/YunFreeTech/kubefree/internal/api/v1/cluster"
	"github.com/YunFreeTech/kubefree/internal/api/v1/imagerepo"
	"github.com/YunFreeTech/kubefree/internal/api/v1/ldap"
	"github.com/YunFreeTech/kubefree/internal/api/v1/proxy"
	"github.com/YunFreeTech/kubefree/internal/api/v1/role"
	"github.com/YunFreeTech/kubefree/internal/api/v1/session"
	"github.com/YunFreeTech/kubefree/internal/api/v1/system"
	"github.com/YunFreeTech/kubefree/internal/api/v1/user"
	"github.com/YunFreeTech/kubefree/internal/api/v1/webkubectl"
	"github.com/YunFreeTech/kubefree/internal/api/v1/ws"
	v1 "github.com/YunFreeTech/kubefree/internal/model/v1"
	v1Role "github.com/YunFreeTech/kubefree/internal/model/v1/role"
	v1System "github.com/YunFreeTech/kubefree/internal/model/v1/system"
	"github.com/YunFreeTech/kubefree/internal/service/v1/common"
	v1RoleService "github.com/YunFreeTech/kubefree/internal/service/v1/role"
	v1RoleBindingService "github.com/YunFreeTech/kubefree/internal/service/v1/rolebinding"
	v1SystemService "github.com/YunFreeTech/kubefree/internal/service/v1/system"
	pkgV1 "github.com/YunFreeTech/kubefree/pkg/api/v1"
	"github.com/YunFreeTech/kubefree/pkg/collectons"
...
func logHandler() iris.Handler {
	return func(ctx *context.Context) {
		...
		path := strings.Replace(ctx.Request().URL.Path, "/kubefree/api/v1/", "", 1)
		currentPath = strings.Replace(currentPath, "/kubefree/api/v1/", "", 1)
...
func apiResourceHandler(party iris.Party) iris.Handler {
	return func(ctx *context.Context) {
		...
		for i := range routes {
			if strings.HasPrefix(routes[i].Path, "/kubefree/api/v1/") {
