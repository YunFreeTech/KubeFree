...
const message = {
    commons: {
        ...
        personal: {
            ...
            star: "点亮 Star",
            version: "版本",
            introduction: "KubeFree 是一款简单易用的开源 Kubernetes 可视化管理面板。",
            introduction2: "KubeFree 允许管理员导入多个 Kubernetes 集群，并且通过权限控制，将不同 cluster、namespace 的权限分配给指定用户。它允许开发人员管理 Kubernetes 集群中运行的应用程序并对其进行故障排查，供开发人员更好地处理 Kubernetes 集群中的复杂性。",
        },
        help: {
            help: "帮助",
            about: "关于",
    ...
    business: {
        ...
        user: {
            ...
            type: "类型",
            ldap_mapping: "用户属性映射",
            ldap_mapping_helper: "用户属性映射代表怎样将LDAP中用户属性映射到kubefree用户上，name, nickName,email 是kubefree的用户需要属性",
        },
        system: {
            system_log: "日志审计",
            operation_log: "操作日志",
