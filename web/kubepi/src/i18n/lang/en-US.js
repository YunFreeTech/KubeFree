...
const message = {
    commons: {
        ...
        personal: {
            ...
            star: "Star",
            version: "Version",
            introduction: "KubeFree is an easy to use open source Kubernetes visual management panel.",
            introduction2: "KubeFree allows administrators to import multiple Kubernetes clusters and assign permissions of different clusters and namespaces to specific users through permission control. It allows developers to manage and troubleshoot applications running in the Kubernetes cluster to better deal with the complexity in the Kubernetes cluster."
        },
        help: {
            help: "Help",
            about: "About",
    ...
    business: {
        ...
        user: {
            ...
            ldap_mapping_helper: "User attribute mapping represents how to map user attributes in LDAP to kubefree users, name, nickName, email are the attributes required by kubefree users",
        },
        system: {
            system_log: "Audits",
