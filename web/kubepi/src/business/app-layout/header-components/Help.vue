  ...
  <el-dropdown trigger="click" @command="handleCommand">
    ...
    <el-dialog class="ko-dialog" :show-close="false" :visible.sync="aboutDialogVisible" width="50%">
      <div class="aboutBackground" style="padding: 20px 25px;">
        <img style="margin-left: 0;" :src="require('@/assets/KubeFree-red.png')" class="sidebar-logo" alt="Sidebar Logo">
...
export default {
  ...
  methods: {
    handleCommand(command) {
      switch (command) {
        case "support":
          window.open("https://YunFreeTech.io/", "_blank")
          break
        case "docs":
          window.open("https://YunFreeTech.io/docs/kubefree/", "_blank")
          break
        default:
    ...
    toGithub() {
      window.open("https://github.com/YunFreeTech/KubeFree", "_blank")
    },
    toIssue() {
      window.open("https://github.com/YunFreeTech/KubeFree/issues", "_blank")
    },
    toTalk() {
      window.open("https://YunFreeTech.io/#contact", "_blank")
    },
    toGithubStar() {
      window.open("https://github.com/YunFreeTech/KubeFree", "_blank")
    },
