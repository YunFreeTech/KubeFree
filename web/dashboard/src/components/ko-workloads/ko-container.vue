...
import {getRepo, listImages} from "../../../../kubefree/src/api/imagerepos"
      ...
      handler(newObj) {
        if (newObj?.annotations){
          ...
          if(this.containerType === "initContainers") {
            itemName = "kubefree-repo-init-" + this.containerParentObj.name + "/"
          } else {
            itemName = "kubefree-repo-" + this.containerParentObj.name + "/"
          }
  ...
  methods: {
    ...
    transformation (parentFrom, metadata) {
      ...
      if (this.containerType === "standardContainers") {
        secrets = "kubefree-repo-" + parentFrom.name + "/" + this.repo.name
      } else {
        secrets = "kubefree-repo-init-" + parentFrom.name + "/" + this.repo.name
      }
