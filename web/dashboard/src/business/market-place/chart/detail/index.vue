      ...
      <el-row type="flex" :gutter="20">
        ...
        <el-col :span="8">
          <div style="text-align: right">
            <el-button  v-has-permissions="{scope:'cluster',apiGroup:'kubefree.org',resource:'appmarkets',verb:'create'}" style="margin-right: 150px" type="primary" @click="install">{{ $t("business.chart.install") }}
            </el-button>
          </div>
        </el-col>
      </el-row>
