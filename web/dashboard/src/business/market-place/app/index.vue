<template>
  <layout-content :header="$t('business.chart.app_installed')">
    <div style="float: left">
      <el-button v-has-permissions="{scope:'cluster',apiGroup:'kubefree.org',resource:'appmarkets',verb:'create'}" type="primary" size="small"
      ...
      buttons: [
        {
          ...
          icon: "el-icon-edit",
          disabled: () => {
            return !checkPermissions({scope:'cluster',apiGroup:'kubefree.org',resource:'appmarkets',verb:'update'})
          },
          click: (row) => {
            this.onUpgrade(row)
          }
        },
        {
          ...
          icon: "el-icon-delete",
          disabled: () => {
            return !checkPermissions({scope:'cluster',apiGroup:'kubefree.org',resource:'appmarkets',verb:'delete'})
          },
          click: (row) => {
            this.onDelete(row)
          }
