...
const (
	LabelManageKey   = "kubefree.org/manage"
	LabelRoleTypeKey = "kubefree.org/role-type"
	LabelClusterId   = "kubefree.org/cluster-id"
	LabelUsername    = "kubefree.org/username"
