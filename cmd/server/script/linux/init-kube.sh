...
code=`curl -w %{http_code} -s -o ~/.kube/config http://localhost/kubefree/api/v1/webkubectl/session?token=${arg1}`
...
echo "Welcome to kubefree web terminal, try kubectl --help."
